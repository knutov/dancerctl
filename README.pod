...
Config format: YAML for the F<~/.dancer/$appname> and any ini-style (as for now) 
for the F</etc/dancer.conf>
...
=over
    ...
    * NOTE! Names or parameters in config can be changed in next versions
