...
for /etc/dancder.conf

=head1 Config example

See app.yml which should be moved to /home/user/.dancer/ and renamed to 'app'.

=head1 Install

Cpanminus and perl 5.10 are required.

cpanm Config::Auto

'dancerctl' was tested under modern version of Ubuntu (11.04). 
